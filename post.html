      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#team">投稿する</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#contact">My Page</a>
            </li>
          </ul>
        </div>
      </div>
...
<!-- ヘッダーここまで -->
    ...
    <div>
      <div class="top-top-top">
        <img class="post-post-img" src="img/header-bg.jpg" >
      </div>
    </div>
      <div class="post-form">
        <form>
